...
# 数据存放位置
DATASET = "/data/nanopore/dL_network/network/cellflow_dataset/"
...
# 模型持久化设置
MODEL_SAVE_PATH = "/data/nanopore/dL_network/network/cnn_cellflow_res/cnn_tf_model/"
MODEL_NAME = "nanopore_classifier.ckpt"
PB_DIR = "/data/nanopore/dL_network/network/cnn_cellflow_res/cnn_tf_model_pb/"
